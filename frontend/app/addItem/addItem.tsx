          ...
          <View style={css.body}>
                ...
                {photo ? (
                  ...
                  <>
                    <Ionicons
                      name="add"
                      size={32}
                      color={css.container.color}
                    />
                    <Text style={css.photoTxt}>Photo</Text>
                  </>
                )}
              </View>
            </Pressable>
            <View style={[css.content]}>
              <View style={[css.contentSection]}>
                <Text style={css.contentName}>Product Name:</Text>
                <TextInput
                  placeholder="Name"
                  value={name}
              ...
              <View style={[css.contentSection]}>
                <Text style={css.contentName}>Quantity:</Text>
                <TextInput
                  placeholder="1kg"
                  value={quantity}
              ...
              <View style={css.contentSectionHorizontal}>
                <View style={[css.contentSection, { flex: 1 }]}>
                  <Text style={css.contentName}>Price:</Text>
                  <TextInput
                    value={price}
                    ...
                    style={[
                      css.nameInput,
                      focus === 'price' && css.focused2,
                      { textAlign: 'center' },
                    ]}
                  />
                </View>
                <View style={[css.contentSection, { flex: 1 }]}>
                  <Text style={css.contentName}>Expiry Date:</Text>
                  <Pressable
            ...
            <View style={[css.contentSection]}>
              <Text style={css.contentName}>Description:</Text>
              <TextInput
                value={desc}
            ...
            <View style={css.buttonView}>
              <Pressable
                style={[css.button, pressed && { transform: 'scale(0.98)' }]}
                onPress={() => {
                  handleSubmit({
                    setPosted,
                    photo,
